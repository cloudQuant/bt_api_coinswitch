...
from bt_api_coinswitch.registry_registration import register
from bt_api_coinswitch import __version__
...
def register_plugin(registry: ExchangeRegistry, runtime_factory: Any) -> PluginInfo:
    ...
    return PluginInfo(
        name="bt_api_coinswitch",
        version=__version__,
        core_requires=">=0.15,<1.0",
        supported_exchanges=("COINSWITCH___SPOT",),
