...
class CoinSwitchOrderData(OrderData):
    """Class CoinSwitchOrderData"""
    def __init__(
        self,
...
class CoinSwitchRequestOrderData(CoinSwitchOrderData):
    """Class CoinSwitchRequestOrderData"""
    pass


class CoinSwitchWssOrderData(CoinSwitchOrderData):
    """Class CoinSwitchWssOrderData"""
    pass
