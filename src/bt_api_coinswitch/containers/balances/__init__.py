...
class CoinSwitchBalanceData(BalanceData):
    """Class CoinSwitchBalanceData"""
    def __init__(
        self,
        balance_info: Any,
        asset_type: str = "SPOT",
    ...
    def init_data(self) -> Self:
        ...
        if isinstance(self.balance_data, dict):
            ...
            self.currency = from_dict_get_string(data, "currency") or from_dict_get_string(
                data, "coin"
            )
            self.available = from_dict_get_float(data, "available", 0.0) or from_dict_get_float(
                data, "free", 0.0
            )
...
class CoinSwitchRequestBalanceData(CoinSwitchBalanceData):
    """Class CoinSwitchRequestBalanceData"""
    pass


class CoinSwitchWssBalanceData(CoinSwitchBalanceData):
    """Class CoinSwitchWssBalanceData"""
    pass
