...
This package provides **CoinSwitch exchange plugin for bt_api framework** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **COINSWITCH** exchange.
...
```
bt_api_coinswitch/
├── src/bt_api_coinswitch/     # Source code
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_coinswitch/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **CoinSwitch exchange plugin for bt_api framework**。它提供了与 **COINSWITCH** 交易所交互的统一接口。
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_coinswitch/issues) 反馈问题
